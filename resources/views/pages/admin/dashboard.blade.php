                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div class="col-9 align-self-center text-right">
                                    <div class="m-l-10">
                                        ...
                                        <p class="mb-0 text-muted">Visits Today <span class="badge bg-soft-success"><i
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled text-center text-muted mt-2 mb-0">
                        <li class="list-inline-item font-13"><i
                                class="mdi mdi-album font-16 text-secondary mr-2"></i>Laptops</li>
                        <li class="list-inline-item font-13"><i class="mdi mdi-album font-16 text-info mr-2"></i>Iphones
                        </li>
                        <li class="list-inline-item font-13"><i class="mdi mdi-album font-16 text-light mr-2"></i>Tablets
                        </li>
                    </ul>
                </div><!--end card-body-->
            </div><!--end card-->
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-2.jpg') }}"
                                            alt="user" width="30">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-3.jpg') }}"
                                            alt="user" width="30">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-4.jpg') }}"
                                            alt="user" width="30">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-5.jpg') }}"
                                            alt="user" width="30">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-6.jpg') }}"
                                            alt="user" width="30">
                                    </td>
                                    <td>
                                        <a href="javascript:void(0);">Ruby T. Curd</a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img class="" src="{{ asset('assets/images/products/pro1.png') }}"
                                            alt="user">
                                    </td>
                                    <td>
                                        Chair
                                ...
                                <tr>
                                    <td>
                                        <img class="" src="{{ asset('assets/images/products/pro2.png') }}"
                                            alt="user">
                                    </td>
                                    <td>
                                        Mobile
                                ...
                                <tr>
                                    <td>
                                        <img class="" src="{{ asset('assets/images/products/pro3.png') }}"
                                            alt="user">
                                    </td>
                                    <td>
                                        LED
                                ...
                                <tr>
                                    <td>
                                        <img class="" src="{{ asset('assets/images/products/pro4.png') }}"
                                            alt="user">
                                    </td>
                                    <td>
                                        Chair
